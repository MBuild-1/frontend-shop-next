...
export const getServerSideProps = async () => {
  try {
    ...
    const productEntries = await loadProductEntryWithFilter(
      `category=Cemilan Buat Rebahan&pageNumber=20&page=1`,
    );
...
const SnackPage = props => {
  ...
  const handleLoadMore = async () => {
    ...
    const encryptType = JSON.parse(
      CryptoJSAesEncrypt(
        `/entry?category=Cemilan Buat Rebahan&pageNumber=20&page=${start}`,
      ),
    );
  ...
  return (
    <>
      <Head>
        <title>Cemilan Buat Rebahan</title>
      </Head>
      <Navbar />
            ...
            {productEntries.data.length !== 0 ? (
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-center">
                  Produk Dari Kategori Cemilan Buat Rebahan Belum Tersedia.
                </p>
              </div>
            )}
          </div>
