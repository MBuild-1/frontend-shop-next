...
export const getServerSideProps = async () => {
  try {
    ...
    const productEntries = await loadProductEntryWithFilter(
      `type=viral&pageNumber=20&page=1`,
    );
...
const ViralPage = props => {
  ...
  const breadcrumbs = [
    ...
    {
      href: '/product/viral',
      label: 'Yang Lagi Viral Di Indonesia',
      isCurrentPage: true,
    },
  ];
  ...
  return (
    <>
      <Head>
        <title>Produk Yang Lagi Viral Di Indonesia | Masterbagasi</title>
      </Head>
      <Navbar />
            ...
            {productEntries.data.length !== 0 ? (
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-center">
                  Produk Dari Kategori Yang lagi viral di Indonesia Belum
                  Tersedia.
                </p>
              </div>
            )}
